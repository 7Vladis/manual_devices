...
from .views import create_user_view, update_user_role_view, toggle_user_status_view, delete_user_view, profile_youtrack_token_view
...
urlpatterns = [
    ...
    path('profile/youtrack-token/', profile_youtrack_token_view, name='profile_youtrack_token'),
]